...
router.get("/postagens",eAdmin,(req,res)=>{
    Postagem.find().lean().populate('categoria').sort({data: 'desc'}).then((postagens) => {
        ...
        req.flash("error_msg","Erro na listagem de posts: " +err)
        res.render("admin")
    })
...
router.get("/postagens/add",eAdmin,(req,res)=>{
    Categoria.find().then((categorias)=>{
        ...
        req.flash("error_msg","Erro ao achar as categorias: "+ err)
...
router.get("/postagens/edit/:id",eAdmin,(req,res) =>{
    ...
    Postagem.findOne({_id:req.params.id}).then((postagem) => {
        ...
        Categoria.find().then((categorias)=>{
            ...
            req.flash("err_msg","Houve um erro ao listar as categorias:" + err)
            res.redirect("/admin/postagens")
        })
            
    }).catch((err)=>{
        req.flash("err_msg","Houve um erro ao carregar o formulario:" + err)
        res.redirect("/admin/postagens")
    })
})
...
router.post("/categorias/deletar",eAdmin,(req,res)=>{
    Categoria.remove({_id:req.body.id}).then(()=>{
        ...
        req.flash("error_msg","Erro deletada com sucesso")
        res.redirect("/admin/categorias")
    })
})
